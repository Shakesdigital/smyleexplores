...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    groupSize: "Solo travelers or small groups",
  ...
  },
  {
    ...
    relatedTourSlugs: ["sunset-cruise-on-the-nile", "source-of-the-nile-boat-tour", "ziplining-on-the-nile"],
  },
  {
  ...
  },
  {
    ...
    relatedTourSlugs: ["horseback-riding-along-the-nile", "bungee-jumping-over-the-nile", "ziplining-on-the-nile"],
  },
  {
    ...
    relatedTourSlugs: ["sunset-cruise-on-the-nile", "quad-biking-safari", "ziplining-on-the-nile"],
  },
  {
  ...
  },
  {
    ...
    relatedTourSlugs: ["sunset-cruise-on-the-nile", "nile-kayaking-adventure", "ziplining-on-the-nile"],
  },
  {
    slug: "ziplining-on-the-nile",
    title: "Ziplining on the Nile",
    shortDescription: "Fly above the Nile on Uganda's longest zipline for panoramic river views and a fast, family-friendly adrenaline hit.",
    duration: "Approx. 30-45 minutes",
    difficulty: "Thrilling / Family-Friendly",
    minAge: "5+ / Max weight: 130kg",
    groupSize: "1-12 guests",
    startingPrice: "From $20 per person",
    location: "Bukaya, Njeru, near Jinja, Uganda",
    heroImage: "/images/ziplining-on-the-nile.jpg",
    highlights: [
      "Two zip lines spanning a combined 620 meters",
      "First line crosses the Nile for 300 meters",
      "Second line returns along the river for 320 meters",
      "Panoramic views near the Source of the Nile",
      "Professional safety briefing and instructor support",
    ],
    included: ["Zipline session", "Safety harness and helmet", "Briefing by trained instructors", "On-site support crew"],
    bring: ["Closed shoes", "Comfortable clothing", "Small camera or phone strap", "Water bottle", "Confidence for heights"],
    overview: [
      "Ziplining on the Nile delivers a quick but memorable rush above one of Uganda's most iconic stretches of water near Jinja.",
      "The experience uses two separate lines totaling 620 meters, sending you out over the river and then back with open views of the Nile and its green shoreline.",
      "It is well suited to travelers who want a scenic adventure that feels exciting without requiring a full day commitment.",
      "With trained instructors, clear safety procedures, and a setting near the Source of the Nile, it works well as a standalone activity or as part of a bigger Jinja adventure day.",
    ],
